...
weight_eq = weight < 50 or weight >= 120
# print(weight_eq)
if age < 30 and weight >= 50 and weight < 120:
    print(name+' ' + surname + ', ' + str(age) + ' год- ' + 'хорошее состояние' )
elif (age >= 30 and age < 40) and weight_eq:
    print(name + ' ' + surname + ', ' + str(age) + ' год- ' + 'требуется начать вести правильный образ жизни')
elif age >= 40 and weight_eq:
    print(name + ' ' + surname + ', ' + str(age) + ' год- ' + 'требуется врачебный осмотр')
else:
    print(name+' ' + surname + ', ' + str(age) + ' год- ' + 'Нормы запредельные! Срочно что-то надо делать!')
